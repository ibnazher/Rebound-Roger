...
namespace Rebound.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [Authorize]
        [AccessAuthorize(Roles = "systemAdmin, Register user")]
        ...
        public ActionResult Setrole()
        {
            ...
            var userlist = db.Users.Where(s => s.Id != username).ToList();
        ...
        public ActionResult SetRoletouser(Guid? id)
        {
            ...
            var rolelist = db.Roles.OrderBy(x => x.Name).Select(s => s.Name).ToList();
